<x-guest-layout>
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('asignar-actividad') }}">
            @csrf
            ...
            <div>
                ...
                <x-text-input id="tiempo_estimado" class="block mt-1 w-full" type="text" name="tiempo_estimado" :value="old('tiempo_estimado')" required autofocus />
            ...
            <x-text-input class="block mt-1 w-full" type="hidden" name="proyecto_id" :value="$project->id" />
